<%@ Page Title="Login" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="OnlineCoursePlatform.Login" %>
                    ...
                    <div class="u-align-center-sm u-align-center-xs u-align-left-lg u-align-left-md u-align-left-xl u-form u-form-1">
                        <form id="RegistrationForm" method="POST" runat="server" class="u-clearfix u-form-spacing-28 u-form-vertical u-inner-form" style="padding: 10px">
                            ...
                            <div class="u-align-center u-form-group u-form-submit u-form-group-4">
                                <asp:Button ID="btnLogin" runat="server" Text="Login" CssClass="u-border-2 u-border-black u-btn u-btn-submit u-button-style u-hover-black u-none u-text-black u-text-hover-white u-btn-1" OnClick="btnLogin_Click"></asp:Button>
                            </div>
                            <asp:Label runat="server" ID="lblStatus" ForeColor="Blue"></asp:Label>
                        </form>
                    </div>
                </div>
            </div>
